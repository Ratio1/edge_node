...
CVE_DB_LAST_UPDATED = "2026-02-19"
...
CVE_DATABASE: list = [
  ...
  CveEntry("elasticsearch", "<5.6.5", "CVE-2017-11480", Severity.MEDIUM, "Cross-site scripting via URL access control bypass", "CWE-79"),
  ...
  # OpenSSL (detected via banner strings)
