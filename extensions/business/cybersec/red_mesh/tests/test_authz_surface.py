...
ENDPOINT_FIRST_ARGS = {
  'prepare_tenant': 'actor',
  'activate_tenant': 'actor',
  'list_tenants': 'actor',
  'get_tenant': 'actor',
  ...
  'put_tenant_integration': 'actor',
  'update_tenant_allow_pentester': 'actor',
  ...
  # RM-084 P7: archive (deactivate) or restore an account.
  'authorize_account_state_change': 'actor',
