...
from .test_tenant_execution_native import ACTOR_ONLY_READ_ROUTES, EFFECT_ROUTES, UNGUARDED_EFFECT_ROUTES, LEGACY_JSON_EXPORT_ROUTES, LEGACY_READ_ROUTES, LEGACY_RULEBOOK_ROUTES, READ_ROUTES, REPO_ROOT, ROUTES, _Comms, _render_native
...
def scheduler_comms(fixture, response_format, metadata=None):
  ...
  scheduler._endpoints = {name: partial(getattr(fixture.Plugin, name), fixture.owner)
                          for name in READ_ROUTES + EFFECT_ROUTES + UNGUARDED_EFFECT_ROUTES}
