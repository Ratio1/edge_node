...
class AI4E_CONSTANTS:
  ...
  AVAILABLE_DATA_SOURCE_VIDEO_STREAM =     {
      "name" : "VideoStream",
      "type" : "VideoStream",
      "description" : "Live RTSP based video stream",
      "url_based" : True,
      "gathering" : True,
    }

  AVAILABLE_DATA_SOURCE_VIDEO_FILE =    {
      "name" : "VideoStreamFromFile",
      "description" : "Video file streamed",
      "type" : "VideoFile",
      "url_based" : True,
      "gathering" : True,
    }

  AVAILABLE_DATA_SOURCE_IMAGE_ARCHIVE = {
      "name" : "ImageArchive",
      "description" : "Archive of images",
      "type" : "ImageArchive",
      "url_based" : True,
      "gathering" : False,
    }
  
  AVAILABLE_DATA_SOURCE_CSV_DATA = {
      "name" : "LiveCSV",
      "description" : "Live CSV data stream",
      "type" : "StructuredSequenceFile",
      "url_based" : True,
      "gathering" : False,
    },
  ...
  JOB_TYPE_VISION = "vision-object-detection-classification"
  JOB_TYPE_TEXT = "text-analysis-and-identification"
  
  JOB_TYPES = [
    JOB_TYPE_VISION, JOB_TYPE_TEXT
  ]

  JOB_CATEGORIES_LIST = [
    {
      "name" : "Known object category classification",
      "id" : "video_processing_01",
      "description" : "Detect a known object then classify it with a custom model",
      "second_stage" : True,
      "type" : JOB_TYPE_VISION,
      "data_sources" : [
       AVAILABLE_DATA_SOURCE_VIDEO_STREAM,
       AVAILABLE_DATA_SOURCE_VIDEO_FILE,
       AVAILABLE_DATA_SOURCE_IMAGE_ARCHIVE
      ],
      "base_classes" : FIRST_STAGE_CLASSES
    },
    {
      "name" : "Custom Object Detection",
      "id" : "video_processing_02",
      "description" : "Detect an before unknown object location in a image",
      "second_stage" : False,
      "type" : JOB_TYPE_VISION,
      "data_sources" : [
       AVAILABLE_DATA_SOURCE_VIDEO_STREAM,
    ...
    {
      "name" : "Custom text line/document classification ",
      "id" : "test_processing_01",
      "description" : "Identify patterns in a small text corpus",
      "second_stage" : False,
      "type" : JOB_TYPE_TEXT,
      "data_sources" : [
        AVAILABLE_DATA_SOURCE_CSV_DATA
