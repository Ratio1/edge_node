...
JOB_TYPE_RESOURCE_SPECS = {
  ...
  51: {DEEPLOY_RESOURCES.CPU: 3, DEEPLOY_RESOURCES.MEMORY: '12g', DEEPLOY_RESOURCES.STORAGE: '48g'}, # med1
  52: {DEEPLOY_RESOURCES.CPU: 8, DEEPLOY_RESOURCES.MEMORY: '22g', DEEPLOY_RESOURCES.STORAGE: '88g'}, # high1
}
...
class DEEPLOY_RUNTIME_KEYS:
  DYNAMIC_ENV = "DYNAMIC_ENV"
  SEMAPHORE = "SEMAPHORE"
  SEMAPHORED_KEYS = "SEMAPHORED_KEYS"

class DEEPLOY_DYNAMIC_ENV_KEYS:
  TYPE = "type"
  SOURCE = "source"
  PATH = "path"

class DEEPLOY_DYNAMIC_ENV_TYPES:
  STATIC = "static"
  HOST_IP = "host_ip"
  SHMEM = "shmem"
...
DEEPLOY_GET_PREFERRED_NODES_REQUEST = {
  "nonce" : hex(int(time() * 1000)), # recoverable via int(nonce, 16)
}
