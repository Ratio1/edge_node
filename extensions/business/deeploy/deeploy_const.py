...
JOB_TYPE_RESOURCE_SPECS = {
  # Generic Apps
  53: {DEEPLOY_RESOURCES.CPU: 0.25, DEEPLOY_RESOURCES.MEMORY: '0.5g', DEEPLOY_RESOURCES.STORAGE: '2g'}, # micro
  ...
  # Services
  55: {DEEPLOY_RESOURCES.CPU: 0.5, DEEPLOY_RESOURCES.MEMORY: '1g', DEEPLOY_RESOURCES.STORAGE: '4g'}, # lite
