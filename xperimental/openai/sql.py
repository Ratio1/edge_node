...
if __name__ == "__main__":
  ...
  INSTRUCTIONS_EXT = """You are a SQL expert. 
...
"""
  ...
  INSTRUCTIONS_SIMPLE = """You are a SQL expert. 
You will be given a data structure raw presentation and your task is to create the DDL (Data Definition Language) for the database. 
...
"""
  ...
  query = """
  I need a data structure for library management system with books, authors, and members.
  """

  from openai import OpenAI

  client = OpenAI(
    api_key=os.environ["EE_OPENAI_API_KEY"],
  )
  
  result1 = client.responses.create(
    model="gpt-4.1-mini",
  ...
  result2 = client.responses.create(
    model="gpt-4.1-mini",
    previous_response_id=result1.id,
    input="Explain the last SQL code line."
  )
